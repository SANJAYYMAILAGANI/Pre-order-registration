...
<html lang="en">
  <head>
    ...
    <title>SUCCESSFULLY CONTESTED</title>
  ...
  <body>
    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand headerFont text-lg"><strong>Pre-Order Registration</strong></a>
        </div>
    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          $name = $email = $mobile = $selection = "";

					if(isset($_POST["submit"])){
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["voterID"]) && isset($_POST["selectedDevice"]))
					{
						$name= test_input($_POST["voterName"]);
						$email= test_input($_POST["voterEmail"]);
						$mobile= test_input($_POST["voterID"]);
						$selection= test_input($_POST["selectedDevice"]);
					}
				}
				else
				{
       ...
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO db_evoting.tbl_users VALUES(null,'".$name."','".$email."','".$mobile."','".$selection."');";
